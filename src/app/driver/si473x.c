...
// SI473X Reset pin (adjust to match your hardware)
#define SI473X_RST_PIN ((gpio_num_t)I2C_PIN_EN)

#define RST_HIGH digitalWrite(SI473X_RST_PIN, LOW)   // Active low reset
#define RST_LOW digitalWrite(SI473X_RST_PIN, HIGH)
